...
export class AavePathBuilder {
    ...
    static buildParams(
        ...
        const typeString = 'tuple(tuple(uint8 dexType, address pool, address tokenIn, address tokenOut, uint256 minOut, uint24 fee)[] path, address titheRecipient)';
