...
export class V3SushiBuilder {
    ...
    static buildParams(
        ...
        const typeString = 'tuple(address poolV3, address poolSushi, uint24 feeV3, uint24 feeSushi, address tokenIn, address tokenIntermediate, address tokenOut, uint256 borrowAmount, uint256 minAmountOutHop1, uint256 minAmountOutHop2, address titheRecipient, uint8 dexType1, uint8 dexType2)';
