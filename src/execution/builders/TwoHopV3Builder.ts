...
export class TwoHopV3Builder {
  ...
  static buildParams(
    ...
    const typeString =
      'tuple(address pool, uint256 amount0, uint256 amount1, tuple(address pool1, address pool2, uint24 fee1, uint24 fee2, address tokenIn, address tokenIntermediate, address tokenOut, uint256 minAmountOutHop1, uint256 minAmountOutHop2, address titheRecipient) callbackParams)';
