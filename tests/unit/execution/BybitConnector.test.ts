...
import { BybitConnector } from '../../../src/execution/cex/BybitConnector.js';
...
describe('BybitConnector', () => {
  ...
  describe('Constructor', () => {
    it('should create connector with valid configuration', () => {
      ...
      const connector = new BybitConnector(config);
    ...
    it('should reject invalid exchange type', () => {
      ...
      expect(() => new BybitConnector(config as CEXConnectionConfig)).toThrow('Invalid exchange');
    });
  ...
  describe('Statistics', () => {
    it('should return initial statistics', () => {
      ...
      expect(stats.exchange).toBe(CEXExchange.BYBIT);
