...
describe('encodeFlashSwapCall', () => {
  describe('encodeFlashSwapCall', () => {
    it('should encode initiateUniswapV3FlashLoan correctly', () => {
      ...
      expect(decoded.params.tokenIntermediate.toLowerCase()).toBe(
        params.tokenIntermediate.toLowerCase()
      );
    ...
    it('should encode initiateTriangularFlashSwap correctly', () => {
      ...
      expect(decoded.params.amountOutMinimumFinal.toString()).toBe(
        params.amountOutMinimumFinal.toString()
      );
      expect(decoded.params.titheRecipient.toLowerCase()).toBe(params.titheRecipient.toLowerCase());
    });
    ...
    it('should encode initiateAaveFlashLoan correctly', () => {
      ...
      expect(decoded.params.path[0].tokenIn.toLowerCase()).toBe(
        params.path[0].tokenIn.toLowerCase()
      );
      expect(decoded.params.path[0].tokenOut.toLowerCase()).toBe(
        params.path[0].tokenOut.toLowerCase()
      );
