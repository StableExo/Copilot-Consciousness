  ...
  describe('simulateDodoSwap', () => {
    ...
    it('should simulate DODO swap selling base token', async () => {
      ...
      const mockDodoContract = {
        querySellBase: {
          staticCall: jest.fn().mockResolvedValue([BigInt('900000'), BigInt('100')]),
        },
        querySellQuote: {
          staticCall: jest.fn(),
        },
      ...
      expect(result.error).toBeNull();
      expect(mockDodoContract.querySellBase.staticCall).toHaveBeenCalledWith(ZeroAddress, 1000000n);
    });
    ...
    it('should simulate DODO swap selling quote token', async () => {
      ...
      const mockDodoContract = {
        ...
        querySellQuote: {
          staticCall: jest.fn().mockResolvedValue([BigInt('1100000'), BigInt('100')]),
        },
      };
