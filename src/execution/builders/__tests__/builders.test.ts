...
describe('Transaction Parameter Builders', () => {
  ...
  describe('AavePathBuilder', () => {
    ...
    it('should throw error for invalid tithe recipient address', () => {
      ...
      expect(() => {
        AavePathBuilder.buildParams(opportunity, simulationResult, mockConfig, 'invalid-address');
    ...
    it('should throw error for invalid fee (> uint24 max)', () => {
      ...
      expect(() => {
        AavePathBuilder.buildParams(opportunity, simulationResult, mockConfig, titheRecipient);
  ...
  describe('TwoHopV3Builder', () => {
    ...
    it('should throw error for non-two-hop opportunity', () => {
      ...
      expect(() => {
        TwoHopV3Builder.buildParams(opportunity, simulationResult, mockConfig, titheRecipient);
  ...
  describe('TriangularBuilder', () => {
    ...
    it('should throw error for non-three-hop opportunity', () => {
      ...
      expect(() => {
        TriangularBuilder.buildParams(opportunity, simulationResult, mockConfig, titheRecipient);
  ...
  describe('SushiV3Builder', () => {
    ...
    it('should throw error for single-hop opportunity', () => {
      ...
      expect(() => {
        SushiV3Builder.buildParams(opportunity, simulationResult, mockConfig, titheRecipient);
  ...
  describe('V3SushiBuilder', () => {
    ...
    it('should throw error for incorrect DEX order', () => {
      ...
      expect(() => {
        V3SushiBuilder.buildParams(opportunity, simulationResult, mockConfig, titheRecipient);
  ...
  describe('Common Validation', () => {
    it('should validate slippage tolerance range', () => {
      ...
      expect(() => {
        AavePathBuilder.buildParams(opportunity, simulationResult, invalidConfig, titheRecipient);
    ...
    it('should validate BigInt types in simulation result', () => {
      ...
      expect(() => {
        AavePathBuilder.buildParams(opportunity, invalidSimulation, mockConfig, titheRecipient);
